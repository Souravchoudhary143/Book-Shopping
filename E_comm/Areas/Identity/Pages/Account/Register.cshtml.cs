...
namespace E_comm.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly RoleManager<IdentityRole> _roleManager; //this is for di, and pass it in ctor
        ...
        public RegisterModel(
           ...
           IUnitOfWork unitOfWork,
            RoleManager<IdentityRole> roleManager) //initialize it below
        {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                CompanyList = _unitOfWork.Company.GetAll().ToList().Select(cl => new SelectListItem()
                {
                    Text = cl.Name,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //admin role Assign
                    //  await _userManager.AddToRoleAsync(user, SD.Role_Admin); //comment after adding one role of admin
                    ...
                    {
                        if(User.IsInRole(SD.Role_Individual) || Input.Role==null)   /*this if statment or check is reponsible when admin add users and his id get loged out after adding user*/
                        { 
